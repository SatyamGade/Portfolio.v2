    ...
    <section className={styles.projects}>
      ...
      <div className={styles.projectDiv}>
        <div className={styles.project}>
          <div className={styles.imgDiv}><Image src={task} alt='taskTracker' className={styles.img}/></div>
          <h3 className={styles.heading}>Task Tracker</h3>
          <p className={styles.description}>In Task Tracker, you can add, edit, delete and filter your tasks. This project created using ReactJS and Bootstrap on local storage.</p>
